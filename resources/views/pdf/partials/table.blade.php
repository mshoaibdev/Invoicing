<table width="100%" class="items-table" cellspacing="0" border="0">
    <tr class="item-table-heading-row">
        ...
        @endforeach --}}
        <th class="pr-20 text-right item-table-heading">
            Quantity
        </th>
        <th class="pr-20 text-right item-table-heading">
            Price
        ...
        @endif
        <th class="text-right item-table-heading">
            Amount
        </th>
    </tr>
    @php
    ...
    @foreach ($invoice->items as $item)
        <tr class="item-row">
            ...
            <td
                ...
                style="vertical-align: top;"
            >
                {{ $formatter->formatCurrency($item['total'], $invoice->customer->currency->code) }}
            </td>
        </tr>
    ...
    <table width="100%" cellspacing="0px" border="0" class="total-display-table @if(count($invoice->items) > 12) page-break @endif">
        <tr>
            ...
            <td class="py-2 border-0 item-cell total-table-attribute-value">
                {{ $formatter->formatCurrency($invoice->subtotal, $invoice->customer->currency->code) }}
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="py-2 border-0 item-cell total-table-attribute-value">
                {{ $formatter->formatCurrency($invoice->tax_amount, $invoice->customer->currency->code) }}
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="py-2 border-0 item-cell total-table-attribute-value">
                {{ $formatter->formatCurrency($invoice->vat_amount, $invoice->customer->currency->code) }}
            </td>
        </tr>
