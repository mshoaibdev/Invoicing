...
const { fetchUsers, users, headers, searchQuery, itemsPerPage, currentPage, deleteUser, resolveUserRoleVariant, isBusy, totalRecords } = useUsers()
        ...
        <VCard title="Users">
          <VCardText class="d-flex flex-wrap py-4 gap-4">
            <VRow>
              ...
              >
                <VBtn
                  v-if="ability.can('Create', 'settings-users-create')"
          ...
          >
            ...
            <template #item.actions="{ item }">
              <VBtn
                v-if="ability.can('Delete', 'settings-users-delete')"
                icon
                variant="text"
                color="default"
                size="x-small"
              ...
              <VBtn
                v-if="ability.can('Update', 'settings-users-edit')"
                icon
                variant="text"
                color="default"
                size="x-small"
